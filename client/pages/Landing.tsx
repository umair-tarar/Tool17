  ...
  return <div className="relative mx-auto w-full max-w-[570px]" aria-label="Preview of the PureListVerifier verification workspace">
    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-[0_24px_60px_rgba(38,55,120,0.16)]">
      <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3 sm:px-5">
        ...
        <span className="rounded-full bg-[#eefaf3] px-2.5 py-1 text-[10px] font-bold text-emerald-700">Subscription active</span>
      </div>
      <div className="grid gap-3 bg-[#fbfcff] p-4 sm:grid-cols-[1fr_150px] sm:p-5">
        ...
        <div className="space-y-3">
          <div className="rounded-xl bg-[#263aaf] p-4 text-white shadow-sm"><p className="text-[10px] font-semibold text-indigo-100">Monthly credits</p><p className="mt-2 text-2xl font-extrabold tracking-tight">100,000</p><div className="mt-3 h-1.5 rounded-full bg-white/20"><div className="h-full w-4/5 rounded-full bg-[#aab9ff]" /></div></div>
...
export default function Landing() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#fcfcff] text-[#152446]">
    ...
    <section className="px-5 py-20 sm:px-8"><div className="mx-auto max-w-5xl rounded-3xl bg-gradient-to-br from-[#1e328e] to-[#5349ad] px-6 py-14 text-center text-white shadow-xl shadow-indigo-200 sm:px-12"><h2 className="text-3xl font-extrabold tracking-[-.04em] sm:text-4xl">Ready to start verifying?</h2><p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-indigo-100">Choose a monthly plan, complete the manual payment review, and then access your protected workspace.</p><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link to="/pricing" className="shine-button inline-flex items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-bold text-[#263b9e] shadow-sm transition hover:bg-indigo-50">View Monthly Plans <ArrowRight size={16} /></Link><Link to="/login" className="shine-button inline-flex items-center justify-center rounded-full border border-white/30 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-white/10">Login</Link></div></div></section>
